...
(function () {
  ...
  // 六組策略：小盤妖股＋資費反殺為主力級；其餘四支為擂台新選手（半自動跟單）。
  var STRATEGIES = [
    {
      code: "SMCP",
      name: "小盤妖股",
    ...
    },
    {
      ...
      side: "long",
      kind: "core",
      desc: "資費極度偏空＝空頭過度擁擠，一反彈就軋空，順勢做多吃燃料。實盤樣本最穩的一支。",
      ...
      fit: "想跟一支『有統計優勢、邏輯清楚』主力多單的人。實盤流水長期正期望，適合當測試帳底倉策略之一。",
      risk: [
        "單邊大跌、資費遲遲不回正時會連續小虧 → 靠固定每筆風險 + 連虧冷卻控制回撤。",
        "盤整期符合條件的幣少、訊號會變稀。",
        "回測 +0.32R/筆、勝率 52.6%（樣本 344），實盤通常略低於回測。"
      ],
      follow: "https://t.me/c/3611242392/250"
    },
    {
